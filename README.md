...
The image below is a public example preview generated from a local research paper (`TwiBot-20.pdf`) in the maintainer's literature library. The source paper itself is not redistributed in this repository.
